<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<style>
		.top-brand {
			...
			box-shadow: 4px 0 6px rgba(30, 144, 255, .8);
		}
		...
		.top-brand .nav .dropdown-menu.profile .exit:hover span.text{
			...
			border-style: solid;
			border-color: #fff;
			background-color: $template2.back.top.menu.exit.hovertext.backgroundColor;
			box-shadow: 0 0 6px rgba(30, 144, 255, 0);
		}
				...
				<div class="container top-brand" style="display: flex;">
					...
					<nav class="navbar navbar-default">			
						<div class="navbar-header">
							<a href="${pageContext.request.contextPath}/index.jsp">星空游戏购买下载平台</a>
						</div>
