...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>订单信息管理</span></li>
								<li class="breadcrumb-item active"><span>订单信息列表</span></li>
							</ol>
						</div>
					</div>
				</div>
	...
	<script>
		...
		function setDataRow(item,number){
            ...
            crossBtn1.innerHTML = "发送"
			crossBtn1.setAttribute("type","button");
			crossBtn1.setAttribute("class","btn btn-primary btn-sm");
			crossBtn1.setAttribute("onclick","crossTable(" + item.id + ",\"youxixiazai\")");
			if(crossBtnControl('发送') == true){
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("dingdanxinxi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"dingdanxinxi");
        ...
        function pay(id){
			...
			window.sessionStorage.setItem('tableName',"dingdanxinxi");
